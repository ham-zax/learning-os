...
→ durable presentation-ready pending subquestion
```
...
- `needs_question`: prepare a complete question under existing criteria; no saved question exists for this phase.
